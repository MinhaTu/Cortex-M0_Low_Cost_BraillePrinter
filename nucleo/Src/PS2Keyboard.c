...
*/
//void teste(Keyboard_TypeDef* keyboard){
//	keyboard->DataPort = GPIOA;//
...
void keyboardClear(Keyboard_TypeDef* keyboard) {//MUDEI
...
int keyboardReadUnicode(Keyboard_TypeDef* keyboard) { // MUDEI
	int result;
